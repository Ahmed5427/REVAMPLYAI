...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Frame 1 — atmospheric background */}
      ...
      <div
        ...
        style={{
          background: [
            "linear-gradient(to right, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.55) 60%, rgba(0,0,0,0.35) 100%)",
      ...
      {/* Blue accent orb (right side, subtle complement to frame) */}
      <div
        ref={orb1}
      ...
      />
      <div ref={orb2} style={{ display: "none" }} />
      ...
      <motion.div
        ...
        style={{ transformOrigin: "left center", zIndex: 2 }}
      />

      {/* Main content */}
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 xl:px-16 pt-32 pb-24" style={{ zIndex: 2 }}>
      ...
      <motion.div
        ...
        className="absolute bottom-10 right-10 lg:right-14 flex flex-col items-center gap-3"
        style={{ zIndex: 2 }}
      >
        <div
